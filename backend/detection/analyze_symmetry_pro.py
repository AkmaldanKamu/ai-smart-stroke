...
# ──────────────────────────────────────────────
# Download model .task jika belum ada
# ──────────────────────────────────────────────
...
def ensure_model():
    if not os.path.exists(MODEL_PATH):
        print("Mengunduh model face_landmarker.task ...")
        urllib.request.urlretrieve(MODEL_URL, MODEL_PATH)
        print("Model berhasil diunduh.")

# ──────────────────────────────────────────────
# Import API baru mediapipe 0.10.x
# ──────────────────────────────────────────────
...
def analyze_symmetry_pro(frame):
    ...
    # Konversi frame BGR → RGB → mp.Image
    ...
    mid_bibir = landmarks[13]   # noqa: F841 (dipakai jika ingin fitur tambahan)
